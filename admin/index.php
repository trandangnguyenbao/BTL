<?php include('partials/menu.php') ?>
    ...
    <?php
        ...
        ?>
            ...
            <div class="col-4 text-center">
            <?php
                    $result = mysqli_query($conn, "SELECT tenmonhang, sum(soluong) as soluong FROM cart_order WHERE soluong = (SELECT MAX(soluong) FROM cart_order)");
                    while ($row = mysqli_fetch_assoc($result)){              
            ...
            <div class="col-4 text-center">
            <?php
                    $result = mysqli_query($conn, "SELECT tenmonhang, sum(soluong) as soluong FROM cart_order WHERE soluong = (SELECT Min(soluong) FROM cart_order)");
                    while ($row = mysqli_fetch_assoc($result)){              
                    $tensanpham = $row['tenmonhang'];
                    }
                ?>
